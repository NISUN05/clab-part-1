...
int main(void)
{
    ...
    // Test big_to_little_endian
    char bytes[4] = {0x00, 0x01, 0x02, 0x03};
    int value = big_to_little_endian(bytes);
    printf("Big to little endian result: %d\n", value);
